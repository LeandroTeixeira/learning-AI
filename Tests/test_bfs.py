...
class MyTestCase(unittest.TestCase):
    ...
    def test_bfs_tree_success(self):
        answers = ["Start at 0", "Start at 0, from 0, go to 1", "Start at 0, from 0, go to 2",
                   "Start at 0, from 0, go to 3", "Start at 0, from 0, go to 4", "Start at 0, from 0, go to 5",
                   "Start at 0, from 0, go to 6", "Start at 0, from 0, go to 7",
                   "Start at 0, from 0, go to 3, from 3, go to 8", "Start at 0, from 0, go to 9",
                   "Start at 0, from 0, go to 3, from 3, go to 8, from 8, go to 10"]

        for i in range(0, 11):
            with self.subTest(name=f"BFS: {i}"):
                path = ', '.join(breadth_first_search_tree(self.test_tree, i))
